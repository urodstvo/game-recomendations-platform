...
def get_actual_popular():
    req = f'fields name; where (rating >= 80) & (hypes > 0) & (first_release_date < {round(datetime(2021,1,1).timestamp())}); ' \
          f'limit 20; sort first_release_date desc;'
    # print(req)
    games = post_req('games', req)
